...
class DataLoader:
    ...
    def load_data(self, data_path, index_dir):
        ...
        pepler_save_dict = {
            "user": self.user_dict.entity2idx,
            "item": self.item_dict.entity2idx
        }

        with open('user_item_mapping.json', 'w', encoding='utf-8') as f:
            json.dump(pepler_save_dict, f, ensure_ascii=False, indent=4)
        print("save user_item_idx successfully")
